...
activities = {
    ...
    "Drama Society": {
        "description": "Perform plays, practice acting, and produce school theater events",
    ...
    "Science Olympiad": {
        "description": "Prepare for academic science competitions across multiple disciplines",
        "schedule": "Tuesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
